...
BASE_PATH="/var/apps/fn-fail2ban/target/www"

# 1. 从 REQUEST_URI 里拿到 index.cgi 后面的路径
#    例如：/cgi/ThirdParty/fn-fail2ban/index.cgi/index.html?foo=bar
...
case "$URI_NO_QUERY" in
  *index.cgi*)
    ...
    # /cgi/ThirdParty/fn-fail2ban/index.cgi/index.html -> /index.html
